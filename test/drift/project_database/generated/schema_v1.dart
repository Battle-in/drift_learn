...
class TaskTable extends Table with TableInfo<TaskTable, TaskTableData> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, description, projectId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class TaskTableData extends DataClass implements Insertable<TaskTableData> {
  ...
  TaskTableData copyWith({int? id, String? description, int? projectId}) =>
      TaskTableData(
        id: id ?? this.id,
        description: description ?? this.description,
  ...
  @override
  int get hashCode => Object.hash(id, description, projectId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
